...
\usepackage{geometry}
\geometry{letterpaper, left=0.8in, right=0.8in, top=0.95in, bottom=0.8in}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\itshape RomânăSimplă: propunere de normalizare și formalizare a limbii române}
...
\title{\Huge\textbf{RomânăSimplă}\\[0.2em]
\LARGE O propunere de normalizare și formalizare a limbii române\\[0.35em]
\large cu nucleu curent restrâns, corpus controlat, operatori și formalizare gramaticală}
...
costul flexiunii, al excepțiilor și al deducției contextuale fragile.
...
continuări scurte}. Fără marker temporal explicit, schema se reduce la
\rs{subiect + predicat}. Propoziția fără subiect exprimat rămâne permisă în
nucleul strict numai pentru impersonale reale, de tipul \rs{ploua.}
...
pronumelor cuantificate în nucleul strict. Forme precum \rs{eu5}, \rs{tu3},
...
strict, alții rămân doar în stratul extins, iar câțiva sunt admiși numai ca
...
nu mai sunt împinse în nucleul strict prin simboluri. Formele principale sunt
...
\RStablelayout
\begin{longtable}{@{}p{0.6cm}p{5.4cm}p{5.5cm}@{}}
\rowcolor{RSGray}
...
\item Coordonările preferă formele lexicale \rs{și}, \rs{sau}, \rs{ori}; simbolurile rămân extinse.
...
dar și unde începe să plătească prețul pentru compactare sau parafrază.
